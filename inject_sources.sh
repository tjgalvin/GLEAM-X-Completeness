...
srun --export=ALL singularity exec $containerImage aegean --cores=$ncpus --out=aegean_list.txt --table=aegean_list.vot --noise=$input_map_rms --background=$input_map_bkg --seedclip=$sigma --floodclip=4 --maxsummits=5 --psf=$input_map_psf $input_map
...
singularity exec $containerImage $MYCODE/calc_r_ratio_cmp.py --z=$z --flux=$s_lin $input_sources $input_map $input_map_psf source_pos_flux${s}.txt
...
srun --export=ALL singularity exec $containerImage AeRes -c aegean_source_list.vot -f $input_map -r sim_and_real_map_flux${s}.fits -m sim_map.fits
...
srun --export=ALL singularity exec $containerImage aegean --cores=$ncpus --out=aegean_SIM_list.txt --table=aegean_SIM_list.vot --noise=$input_map_rms --background=$input_map_bkg --seedclip=$sigma --floodclip=4 --maxsummits=5 --psf=$input_map_psf sim_and_real_map_flux${s}.fits
